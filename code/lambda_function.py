...
def handler(event, context):
    ...
    cluster_id = client.run_job_flow(
                ...
                LogUri='s3://igti-edc-mod1-datalake/emr-logs',
                ...
                Instances={
                    ...
                    'Ec2KeyName': 'KeyMaster',
                    'KeepJobFlowAliveWhenNoSteps': True,
                    'TerminationProtected': False,
                    'Ec2SubnetId': 'subnet-1df39e13'
                },
                ...
                Steps=[{
                    ...
                    'HadoopJarStep': {
                        ...
                        'Args': ['spark-submit',
                                 ...
                                 '--master', 'yarn',
                                 '--deploy-mode', 'cluster',
                                 's3://igti-edc-mod1-datalake/emr-code/pyspark/01_delta_spark_insert.py'
                                 ]
                    }
                },
                {
